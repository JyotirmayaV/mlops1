...
data_file.read()
data_file.write(str(scores[1]))
data_file.close()

email_matter = open('email_matter.txt','r+')
email_matter.read()
email_matter.write('---------------------------------------------')
email_matter.write(this_layer)
email_matter.write('Accuracy achieved : ' + str(scores[1]))
email_matter.close()
